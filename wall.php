<?php
	...
	$join_tables_query = "SELECT users.first_name, users.last_name, messages.message, messages.created_at, messages.message, messages.id as message_id
					  	  FROM users
	...
	$_SESSION['message_id'] = $comments[0]['message_id'];
		...
		<div id="main-content">
			...
			<div class="messages-box">
				...
				<?php	foreach($messages as $message)
						{ ?>
							<li><p class="content-m"><?php echo $message['message']; ?></p>
				...
				<?php	foreach($comments as $comment)
						{ 
							...
							{ ?>
							<li><p class="content-c"><?php echo $comment['comment']; ?></p>
